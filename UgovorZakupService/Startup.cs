...
using UgovorZakupService.Helper;

namespace UgovorZakupService
{
    public class Startup
    {
            ...
            services.AddSwaggerGen(setupAction =>
            {
                setupAction.SwaggerDoc("PublicBiddingOpenApiSpecification",
                    new Microsoft.OpenApi.Models.OpenApiInfo()
                    {
                        ...
                        Description = "Pomoću ovog API-ja može da se vrši kreiranje ugovora o zakupu kao i pregled i izmena ugovora o zakupu",
                        Contact = new Microsoft.OpenApi.Models.OpenApiContact
                        {
                            Name = "Mihailo Jakovljevic",
                            Email = "mihailo.jakovljevic@gmail.com",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(setupAction =>
            {
                ...
                setupAction.SwaggerEndpoint("/swagger/PublicBiddingOpenApiSpecification/swagger.json", "Ugovor o zakupu API");
